...
export const metadata: Metadata = {
  title: "프로 솔랭 트래커 — 프로 솔로랭크 트래커",
  description:
    "프로게이머들의 솔로랭크 실시간 전적, 티어, LP를 한눈에 확인하세요.",
};
    ...
    <html lang="ko">
      <body className={`${geist.className} bg-gray-50 dark:bg-gray-950 text-gray-900 dark:text-gray-100 min-h-screen`}>
        ...
        <footer className="text-center text-xs text-gray-400 dark:text-gray-600 py-8 px-4">
          <p>
            프로 솔랭 트래커 is not endorsed by Riot Games and does not reflect
            the views of Riot Games or anyone officially involved in producing
